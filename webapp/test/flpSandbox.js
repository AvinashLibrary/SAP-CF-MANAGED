		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Managed By SAP",
									"targetURL": "#applicatioui-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"applicatioui-display": {
								"semanticObject": "applicatioui",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=applicatioui",
									"url": sap.ui.require.toUrl("applicatioui")
								}
							}
						}
					}
